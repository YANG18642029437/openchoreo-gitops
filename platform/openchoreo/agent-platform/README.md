...
development 当前固定的观测资源发布为：`clickhouse-78f9964f7f`、`langfuse-57cb8b689b`、`langfuse-retention-5999ddbc97`；Redis 凭据隔离变更固定为 `redis-78bc6c7cb`。这些名称来自 homelab 集群实际生成结果，不是预测哈希。
